...
command_phrases = [
    'Regenerate this note in a concise, clinical manner. Keep existing placeholder numbers in their curly braces. Do not add any numbers or unnecessary information. Do not use helper phrases such as "Here is the rewritten note". If the last variable is {10}, do not add any surrounding phrases.',
    'Rewrite this note formally and clinically, preserving placeholder numbers in curly braces. Avoid adding any numbers or extra details. Do not use introductory phrases like "Here is the rewritten note". If the last variable is {10}, do not add any surrounding phrases.',
    'Reconstruct this note in a clinical and concise, maintaining the placeholder numbers within curly braces. Do not introduce new numbers or superfluous content. Exclude lead-in phrases such as "Here is the rewritten note". If the last variable is {10}, do not add any surrounding phrases.',
    'Transform this note into a clinical, concise version. Retain placeholder numbers in curly braces without adding new numbers or unnecessary details. Omit preambles like "Here is the rewritten note". If the last variable is {10}, do not add any surrounding phrases.',
    'Rephrase this note with a clinical and formal tone, ensuring placeholder numbers in curly braces are preserved. Do not include additional numbers or extraneous information. Avoid introductory statements like "Here is the rewritten note". If the last variable is {10}, do not add any surrounding phrases.'
]